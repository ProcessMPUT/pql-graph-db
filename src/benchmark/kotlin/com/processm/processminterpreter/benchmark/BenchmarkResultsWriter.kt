...
class BenchmarkResultsWriter(
    ...
    private fun writeSummary(
        ...
        val markdown = buildString {
            ...
            appendLine(".\\scripts\\run-compatibility-report.ps1 -QuerySource dropdown -Profile extended -IncludeMultiLogChecks -MultiLogCasesPath .\\scripts\\verify-compatibility.multi-log.cases.local.json -SkipFailureSnapshots -MeasurePayloadSize")
            appendLine("```")
            appendLine()
            ...
            appendLine()
            appendLine("```powershell")
            appendLine("python .\\scripts\\benchmarks\\plot-benchmark-results.py $outputDirectory")
            appendLine("```")
        }
