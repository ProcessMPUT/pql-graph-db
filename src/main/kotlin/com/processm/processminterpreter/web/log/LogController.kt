...
import com.processm.processminterpreter.xes.AttributeFilter
import com.processm.processminterpreter.xes.ImportXesLogRequest
import com.processm.processminterpreter.xes.ImportSampleXesLogRequest
import com.processm.processminterpreter.xes.LogNotFoundException
import com.processm.processminterpreter.xes.LogService
import com.processm.processminterpreter.xes.SearchLogsRequest
import com.processm.processminterpreter.xes.CreateLogRequest as CreateLogCommand
import com.processm.processminterpreter.xes.UpdateLogRequest as UpdateLogCommand
...
class LogController(
    ...
    override fun uploadXESFile(
        ...
        return try {
            ...
            val result = logs.importXes(ImportXesLogRequest(input = inputStream, logId = logId))
