...
object StandardAttributeCatalog {
    ...
    private val typeByCanonicalName: Map<String, Type> = mapOf(
        ...
        // Reference types concept:instance as String (Attribute.kt:80-84), not ID.
        CONCEPT_INSTANCE to Type.STRING,
     ...
     */
    // Scope tables mirror the reference exactly (processm Attribute.kt:28-59):
    // a shorthand is the SUFFIX of a standard name valid at that scope, and `id`
    // resolves to identity:id everywhere. db:id exists only at LOG scope;
    // concept:instance only at EVENT scope.
