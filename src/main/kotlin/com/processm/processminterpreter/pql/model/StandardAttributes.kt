...
object StandardAttributes {
     ...
     */
    fun getNeo4jPropertyFromShorthand(
        scope: Scope,
        shorthand: String,
    ): String? {
     ...
     */
    fun getType(standardName: String): Type = ATTRIBUTE_TYPES[standardName] ?: Type.UNKNOWN
     ...
     */
    fun isClassifier(attributeName: String): Boolean = attributeName.startsWith("c:") || attributeName.startsWith("classifier:")
}
