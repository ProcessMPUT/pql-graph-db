 ...
 *
 * These tests define the expected behavior of the PQL query parser.
 * Any changes to the parser should pass all these tests.
 */
@Tag("PQL")
...
class QueryTests {
    ...
    fun basicSelectTest() {
        ...
        assertEquals(StandardAttributes.CONCEPT_NAME, query.selectStandardAttributes[Scope.Log]!!.elementAt(0).standardName)
        ...
        assertEquals(StandardAttributes.CONCEPT_NAME, query.selectStandardAttributes[Scope.Trace]!!.elementAt(0).standardName)
        assertEquals(StandardAttributes.COST_CURRENCY, query.selectStandardAttributes[Scope.Trace]!!.elementAt(1).standardName)
        ...
        assertEquals(StandardAttributes.CONCEPT_NAME, query.selectStandardAttributes[Scope.Event]!!.elementAt(0).standardName)
        assertEquals(StandardAttributes.COST_TOTAL, query.selectStandardAttributes[Scope.Event]!!.elementAt(1).standardName)
    ...
    fun scopedSelectAllTest() {
        ...
        assertEquals(0, query.selectExpressions[Scope.Trace]!!.size)
        assertEquals(StandardAttributes.CONCEPT_NAME, query.selectStandardAttributes[Scope.Trace]!!.elementAt(0).standardName)
        assertEquals(StandardAttributes.COST_TOTAL, query.selectStandardAttributes[Scope.Trace]!!.elementAt(1).standardName)
        assertTrue(query.selectStandardAttributes[Scope.Trace]!!.all { it.isStandard })
        assertTrue(query.selectStandardAttributes[Scope.Trace]!!.all { it.effectiveScope == Scope.Trace })
        assertTrue(query.selectStandardAttributes[Scope.Trace]!!.all { !it.isClassifier })
        // event scope - attributes cleared because of SELECT *
    ...
    fun selectNonStandardAttributesTest() {
        ...
        assertEquals(StandardAttributes.TIME_TIMESTAMP, query.selectOtherAttributes[Scope.Event]!!.elementAt(1).name)
    ...
    fun groupEventByStandardAttributeTest() {
        ...
        assertEquals(StandardAttributes.CONCEPT_NAME, query.groupByStandardAttributes[Scope.Event]!!.elementAt(0).standardName)
    ...
    fun groupTraceByEventStandardAttributeTest() {
        ...
        assertTrue(query.groupByStandardAttributes[Scope.Trace]!!.all { it.isStandard })
        assertTrue(query.groupByStandardAttributes[Scope.Trace]!!.all { !it.isClassifier })
        assertEquals(StandardAttributes.CONCEPT_NAME, query.groupByStandardAttributes[Scope.Trace]!!.elementAt(0).standardName)
        assertEquals(StandardAttributes.CONCEPT_NAME, query.groupByStandardAttributes[Scope.Event]!!.elementAt(0).standardName)
    ...
    fun groupLogByEventStandardAttributeTest() {
        ...
        assertEquals(StandardAttributes.CONCEPT_NAME, query.groupByStandardAttributes[Scope.Log]!!.elementAt(0).standardName)
    ...
    fun groupByImplicitFromSelectTest() {
        ...
        assertEquals(3, query.selectExpressions[Scope.Event]!!.size)
        assertTrue(query.selectExpressions[Scope.Event]!!.all { !it.isTerminal })
        assertTrue(query.selectExpressions[Scope.Event]!!.all { it is PQLFunction && it.functionType == FunctionType.Aggregation })
        assertEquals(0, query.groupByStandardAttributes[Scope.Log]!!.size)
        assertEquals(0, query.groupByStandardAttributes[Scope.Trace]!!.size)
        assertEquals(0, query.groupByStandardAttributes[Scope.Event]!!.size)
        assertEquals(0, query.groupByOtherAttributes[Scope.Log]!!.size)
    ...
    fun groupByImplicitWithHoistingTest() {
        ...
        assertEquals(0, query.selectExpressions[Scope.Event]!!.size)
        assertTrue(query.selectExpressions[Scope.Log]!!.all { !it.isTerminal })
        assertTrue(query.selectExpressions[Scope.Log]!!.all { it is PQLFunction && it.functionType == FunctionType.Aggregation })
        assertEquals(0, query.groupByStandardAttributes[Scope.Log]!!.size)
        assertEquals(0, query.groupByStandardAttributes[Scope.Trace]!!.size)
        assertEquals(0, query.groupByStandardAttributes[Scope.Event]!!.size)
        assertEquals(0, query.groupByOtherAttributes[Scope.Log]!!.size)
    ...
    fun groupByWithHoistingAndOrderByCountTest() {
        ...
        assertEquals(0, query.selectExpressions[Scope.Event]!!.size)
        assertTrue(query.selectExpressions[Scope.Trace]!!.all { !it.isTerminal })
        assertTrue(query.selectExpressions[Scope.Trace]!!.all { it is PQLFunction && it.functionType == FunctionType.Aggregation })
        assertEquals(0, query.groupByStandardAttributes[Scope.Log]!!.size)
        assertEquals(1, query.groupByStandardAttributes[Scope.Trace]!!.size)
        assertEquals(0, query.groupByStandardAttributes[Scope.Event]!!.size)
