...
class QueryTestsPorted {
    ...
    fun errorHandlingTest_Select() {
        assertThrowsPQL(PQLSyntaxException::class.java, "select")
    }

    @Test
    fun errorHandlingTest_SelectStarFrom() {
        assertThrowsPQL(PQLSyntaxException::class.java, "select * from")
    }

    @Test
    fun errorHandlingTest_SelectWhere() {
        assertThrowsPQL(PQLSyntaxException::class.java, "select e:name where")
    }

    @Test
    fun deleteWithGroupByNotAllowed() {
        assertThrowsPQL(PQLSyntaxException::class.java, "delete event group by l:name")
    }

    @Test
    fun deleteWithSelectNotAllowed() {
        assertThrowsPQL(PQLSyntaxException::class.java, "select e:name delete event where l:name='abc'")
    }
}
